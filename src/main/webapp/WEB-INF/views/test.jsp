...
.bimg_right {
	...
	right: 0;
	bottom: 0;
	filter: invert(27%) sepia(11%) saturate(41%) hue-rotate(201deg)
																...
																.each(
																		...
																		function(
																			...
																			events
																					.push({
																						start : obj.ex_day,
																						title : ((4 * (3.5 * obj.user_weight * obj.timediff)) / 1000)
																								* 5
																								+ "kal"
																					})
																		})
...
<script>
	...
	window.onload = function() {
		...
		//1.값이 뿌려진 뷰단에 classname들을 가져온다
		//2.classname별로 클릭 이벤트가 실행되면 myfunction이 실행된다
		...
		document.querySelector('.black_bg')
				.addEventListener('click', offClick2);

	}
</script>
<script type="text/javascript">
	$(".fc-event-title-container").on('click', function(){
		$('.modal2_wrap').style('display', 'block')
...
<body>
	...
	<div class="modal_wrap">
		<div class="modal_top">
			<div id="NSK_font" style="font-size: 80px;">
				<b><br>이진영 님</b>
			</div>
			...
			<div class="modal_top_right">
				<div id="NSK_font">
					<br>2021-12-07<br>D-day 30일
				</div>
			</div>
		</div>
		<div class="modal_mid">
			<div class="modal_mid_mid">
				<div class="modal_mid_left">
					<img id="moicon" src="resources/img/diary.png">
				</div>
				<div class="modal_mid_right">
					<b id="modal_mid_b">운동 다이어리</b>
				</div>
			</div>
			<div class="modal_mid_mid">
				<div class="modal_mid_left">
					<img id="moicon" src="resources/img/dumbbell.png">
				</div>
				<div class="modal_mid_right">
					<b id="modal_mid_b">운동 도구</b>
				</div>
			</div>
			<div class="modal_mid_mid">
				<div class="modal_mid_left">
					<img id="moicon" src="resources/img/video.png">
				</div>
				<div class="modal_mid_right">
					<b id="modal_mid_b">운동 영상</b>
				</div>
			</div>
		</div>
		<div class="modal_bot">
	...
	<div class="modal2_wrap">
		<div class="modal2_top">
			...
			<div id="NSK_font" class="modal2_top_bot">
				<div id="NSK_font">
					1set x 12reps<br>2set x 12reps <br>3set x 12reps<br>4set
					x 12reps
				</div>
			</div>
		</div>
	...
	<div class="main_map">
		...
		<div class="main_bot">
			<div class="bot_left">
				<img class="bimg_left" src="resources/img/woman.png">
			</div>
			<div class="bot_right">
				<a href="http://localhost:8081/web/main.do"><img
					class="bimg_right" src="resources/img/gym (1).png"></a>
			</div>
		</div>
